...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('requestquote');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Serole\RequestQuote\Model\Requestquote')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('requestquote/*/index');
    }
