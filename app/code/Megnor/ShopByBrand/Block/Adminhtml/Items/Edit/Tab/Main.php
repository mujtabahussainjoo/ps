 ...
 /**
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            'metatitle',
            'text',
            ['name' => 'metatitle', 'label' => __('Meta Title'), 'title' => __('Meta Title'), 'required' => true]
        );

        $fieldset->addField(
            'metadescription',
            'editor',
            ['name' => 'metadescription', 'label' => __('Meta Description'), 'title' => __('Meta Description'), 'required' => true]
        );
		
		$fieldset->addField(
            'metakeywords',
            'editor',
            ['name' => 'metakeywords', 'label' => __('Meta Keywords'), 'title' => __('Meta Keywords'), 'required' => true]
        );

        $fieldset->addField(
            'opengraph_title',
            'text',
            ['name' => 'opengraph_title', 'label' => __('Open Graph Title'), 'title' => __('Open Graph Title'), 'required' => true]
        );
