...
class Topmega extends Topmenu 
{
    ...
    protected function _addSubMenu2($child, $childLevel, $childrenWrapClass, $limit)
    {
        ...
        $category = "";
        if ($childLevel == 0) {
        //$html .= '<ul><div class="sub-menu-pos"><div class="sub-child-menu-img"><img src="https://banner2.kisspng.com/20180721/fo/kisspng-barcode-scanners-image-scanner-point-of-sale-2d-co-barcode-scanner-5b5343d6ce1cb8.9087885115321835108443.jpg"/></div><div class="sub-child-menu-ele">';
		$html .= '<ul><div class="sub-menu-pos"><div class="sub-child-menu-ele">';
        ...
        if($category->getUseStaticBlock())
        {
          ...
          {
          $html .= '<li style="margin-top:20px;" class="bottomstatic" >';
