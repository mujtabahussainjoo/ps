...
namespace Megnor\Blog\Block\Catalog\Product;
 ...
 */
class RelatedPosts extends \Megnor\Blog\Block\Post\PostList\AbstractList
{
    ...
    protected function _preparePostCollection()
    {
        ...
        $this->_postCollection->getSelect()->joinLeft(
            ['rl' => $product->getResource()->getTable('megnor_blog_post_relatedproduct')],
