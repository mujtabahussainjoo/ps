...
namespace Megnor\Blog\Block\Adminhtml\Import\Wordpress;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
         ...
         */
        if ($this->_authorization->isAllowed('Megnor_Blog::import')) {
        ...
        $this->_eventManager->dispatch('megnor_blog_import_wordpress_prepare_form', ['form' => $form]);
