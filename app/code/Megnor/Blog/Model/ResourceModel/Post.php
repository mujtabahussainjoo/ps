...
namespace Megnor\Blog\Model\ResourceModel;
...
class Post extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('megnor_blog_post', 'post_id');
    }
    ...
    protected function _beforeDelete(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $this->getConnection()->delete($this->getTable('megnor_blog_post_store'), $condition);
        $this->getConnection()->delete($this->getTable('megnor_blog_post_category'), $condition);
        $this->getConnection()->delete($this->getTable('megnor_blog_post_relatedproduct'), $condition);

        $this->getConnection()->delete($this->getTable('megnor_blog_post_relatedpost'), $condition);
        $this->getConnection()->delete($this->getTable('megnor_blog_post_relatedpost'),
    ...
    protected function _beforeSave(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $identifierGenerator = \Magento\Framework\App\ObjectManager::getInstance()
                ->create('Megnor\Blog\Model\ResourceModel\PageIdentifierGenerator');
    ...
    protected function _afterSave(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $this->_updateLinks($object, $newIds, $oldIds, 'megnor_blog_post_store', 'store_id');
        ...
        if (is_array($newIds)) {
            ...
            $this->_updateLinks($object, $newIds, $oldIds, 'megnor_blog_post_category', 'category_id');
        }
        ...
        if (is_array($linksData)) {
            ...
            $this->_updateLinks($object, array_keys($linksData), $oldIds, 'megnor_blog_post_relatedpost', 'related_id', $linksData);
        }
        ...
        if (is_array($linksData)) {
            ...
            $this->_updateLinks($object, array_keys($linksData), $oldIds, 'megnor_blog_post_relatedproduct', 'related_id', $linksData);
        }
    ...
    protected function _getLoadByIdentifierSelect($identifier, $storeIds, $isActive = null)
    {
        $select = $this->getConnection()->select()->from(
            ...
            ['cps' => $this->getTable('megnor_blog_post_store')],
    ...
    {
        return $this->_lookupIds($postId, 'megnor_blog_post_store', 'store_id');
    }
    ...
    {
        return $this->_lookupIds($postId, 'megnor_blog_post_category', 'category_id');
    }
    ...
    {
        return $this->_lookupIds($postId, 'megnor_blog_post_relatedpost', 'related_id');
    }
    ...
    {
        return $this->_lookupIds($postId, 'megnor_blog_post_relatedproduct', 'related_id');
    }
