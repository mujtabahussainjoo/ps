...
class Data extends Main
{
    ...
    public function isDisableAmpMode()
    {
        return ! $this->moduleEnabled()
            || '1' === $this->_getRequest()->getParam(self::DISABLE_AMP_PARAMETER)
            || $this->isDisabledUrl();
    }
     ...
     * Set redirect to amp page
     */
    public function redirectToAmpPageVersion()
    {
        $this->response->setRedirect($this->getAmpUrl());
    }
    ...
    public function isAmpRequest()
    {
        if ($this->_isAmpRequest === null) {
            ...
            if ($this->_request->getParam(self::DISABLE_AMP_PARAMETER) == 1) {
                return false;
            }
    ...
    public function getCanonicalUrl($url = null, $params = null)
    {
        ...
        return $urlData['scheme'] . '://' . $urlData['host'] . $this->_getPort($urlData)
    ...
    /**
     * @deprecated since 2.6.0 - use \Plumrocket\Amp\Helper\Form::getAmpAddToCartUrl($productId) instead
     *
