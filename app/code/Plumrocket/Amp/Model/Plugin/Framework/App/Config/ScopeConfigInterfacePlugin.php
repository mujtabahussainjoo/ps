...
class ScopeConfigInterfacePlugin
{
    ...
    private $ampConfigValue = [
        'amshopby/category_filter/enabled' => 0,
        'po_compressor/general/is_enabled' => 0,
        'amoptimizer/general/enabled' => 0,
        'newrelicreporting/general/enable' => 0,
        'cleverdeferjs/general/enable' => 0,
    ];

    /**
     * @param \Plumrocket\Amp\Helper\Data\Proxy $dataHelper
     * @param array $data
     */
    public function __construct(
        \Plumrocket\Amp\Helper\Data\Proxy $dataHelper,
        array $data = []
    ) {
