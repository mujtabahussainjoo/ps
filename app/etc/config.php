...
return [
    'modules' => [
        ...
        'LizardMedia_ProductAttachment' => 1,
        ...
        'Plumrocket_Base' => 1,
        'Plumrocket_Amp' => 1,
        'Serole_AdminOrderCount' => 1,
        'Serole_AdminShipping' => 1,
        'Serole_AutoInvoice' => 0,
        'Serole_Autoinvoiceemail' => 1,
        'Serole_CallForPrice' => 1,
        'Serole_MobileView' => 1,
        'Serole_OrderComments' => 1,
        'Serole_PaymentMethodShow' => 1,
        'Serole_PdfInvoice' => 1,
        'Serole_ProductGrid' => 1,
        'Serole_Productattachment' => 1,
        'Serole_RequestQuote' => 1,
        'Serole_Specialproduct' => 1,
